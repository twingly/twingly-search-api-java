...
import static com.twingly.search.Constants.SEARCH_QUERY_DATE_FORMAT;

/**
 * The type Query.
 */
public class Query {
    private static final SimpleDateFormat QUERY_DATE_FORMAT = new SimpleDateFormat(SEARCH_QUERY_DATE_FORMAT);
