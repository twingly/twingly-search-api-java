...
class UrlConnectionClientSpockTest extends Specification {
    ...
    def "should parse valid links result"() {
        ...
        result.posts[0].latitude == null
        result.posts[0].longitude == null
    ...
    def "should parse minimal valid result"() {
        ...
        result.posts[0].languageCode == "sv"
        result.posts[0].locationCode == "se"
        result.posts[0].latitude == 49.1
        result.posts[0].longitude == 10.75
        result.posts[0].links == []
        ...
        result.posts[1].latitude == null
        result.posts[1].longitude == null
        ...
        result.posts[2].latitude == null
        result.posts[2].longitude == null
